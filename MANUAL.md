...
4. Click **Edit** on your policy (**Allow Users**)
...
- **Access Groups** - create reusable groups in Zero Trust → Access → Access Groups, then update your policy to use the **Access Groups** selector instead of individual emails

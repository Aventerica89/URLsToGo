...
- `1p-local-auth` (github.com/Aventerica89/1p-local-auth) — companion Claude Code plugin for managing local dev OAuth credentials via 1Password; shares the same target user persona. See `marketing/companion-context.md` for cross-promotion strategy.
